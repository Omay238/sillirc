...
fn main() -> eframe::Result {
    ...
    eframe::run_native(
        "sillirc",
        native_options,
        Box::new(|cc| Ok(Box::new(sillirc::SillircApp::new(cc)))),
    )
}
...
fn main() {
    ...
    wasm_bindgen_futures::spawn_local(async {
        ...
        let canvas = document
            .get_element_by_id("sillirc_canvas")
            .expect("Failed to find sillirc_canvas")
            .dyn_into::<web_sys::HtmlCanvasElement>()
            .expect("sillirc_canvas was not a HtmlCanvasElement");
